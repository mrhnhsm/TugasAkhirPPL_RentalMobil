      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html">PANEL PERUSAHAAN RENTAL</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="index.html">PRR</a>
          </div>
          <ul class="sidebar-menu">
              ...
              <li><a class="nav-link" href="<?php echo base_url('rental/transaksi') ?>"><i class="fas fa-random"></i> <span>Transaksi Rental</span></a></li>

              <li><a class="nav-link" href="<?php echo base_url('rental/laporan') ?>"><i class="fas fa-clipboard-list"></i> <span>Laporan Transaksi</span></a></li>
