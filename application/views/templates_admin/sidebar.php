      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="<?php echo (strpos(current_url(), "admin/data_type") !== false) ? "active" : ""?>"><a class="nav-link" href="<?php echo base_url('admin/data_type') ?>"><i class="fas fa-grip-horizontal"></i> <span>Type Mobil</span></a></li>

              <li class="<?php echo (strpos(current_url(), "admin/data_customer") !== false) ? "active" : ""?>"><a class="nav-link" href="<?php echo base_url('admin/data_customer') ?>"><i class="fas fa-user"></i> <span>Data Pelanggan</span></a></li>

              <li class="<?php echo (strpos(current_url(), "admin/transaksi") !== false) ? "active" : ""?>"><a class="nav-link" href="<?php echo base_url('admin/transaksi') ?>"><i class="fas fa-random"></i> <span>Transaksi Rental</span></a></li>
