...
<head>
    ...
    <!--=== Favicon ===-->
    <link rel="shortcut icon" href="<?php echo base_url() ?>assets/assets_shop/img/logo11.png" type="image/x-icon" />

    <title>ZUR Rental Mobil Medan</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <a href="<?php echo base_url() ?>" class="logo">
                            <img src="<?php echo base_url() ?>assets/assets_shop/img/logo11.png" alt="JSOFT">
                        </a>
                    </div>
                    <!--== Logo End ==-->
                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright">
                            <ul>
                                ...
                                <?php }else{ ?>
                                    <li><a href="<?php echo base_url('register') ?>">Daftar Akun</a></li>
