					...
					<tr>
						...
						<td>
							...
							<?php if($tr->status_rental == "Selesai") { ?>
								...
								<button class="btn btn-sm btn-primary" disabled>Rental Sudah Selesai</button>

							<?php } else { ?>

								<a href="<?php echo base_url('customer/transaksi/pembayaran/' . $tr->id_rental) ?>" class="btn btn-sm btn-success">Pembayaran Pesanan</a>

								<a onclick="return confirm('Anda yakin membatalkan?')" class="btn btn-sm btn-danger" href="<?php echo base_url('customer/transaksi/batal_transaksi/' . $tr->id_rental) ?>">Batal Pesanan</a>
