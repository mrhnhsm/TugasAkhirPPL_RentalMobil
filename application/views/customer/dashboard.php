                    ...
                    <div class="slideshowcontent">
                        <div class="display-table">
                            <div class="display-table-cell">
                                <h1>SELAMAT DATANG DI ZUR RENTAL!</h1>
                                <p>RENTAL MOBIL TERBAIK SE-MEDAN<br>HARGA BERSAHABAT, DENGAN KUALITAS PALING MANTAP</p>
                            ...
                            <div class="single-partner">
                                <div class="display-table">
                                    <div class="display-table-cell">
                                        ...
                                        <h5> <!--?php echo $rt->nama_rental ? --> ZUR RENTAL MOBIL MEDAN</h5>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title  text-center">
                        ...
                        <p>Mobil Pilihan Terbaik Untuk Kenyamanan Anda</p>
                    </div>
                </div>
                <!-- Section Title End -->
            </div>
