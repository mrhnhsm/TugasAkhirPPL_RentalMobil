	...
	<div class="row">
		...
		<div class="col-md-4">
			<div class="card" style="margin-top: 110px">
				...
				<div class="card-body">
					<p class="text-success mb-3"> Silahkan Melakukan Pembayaran Melalui Rekening / Dompet Digital Di bawah :</p>
					...
					<?php } elseif($tr->status_pembayaran == "0") { ?>
						<button style="width: 100%" type="button" class="btn btn-warning btn-sm mt-3 disabled"><i class="fa fa-clock-o"></i> Menunggu Konfirmasi Admin</button>
