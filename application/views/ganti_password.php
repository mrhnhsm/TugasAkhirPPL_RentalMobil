        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              <div class="card-header"><h4>Ganti Password Anda</h4></div>
              ...
              <div class="card-body">
                <form method="POST" action="<?php echo base_url('auth/ganti_password_aksi') ?>">
                  ...
                  <div class="form-group">
                    <div class="d-block">
                    	<label for="pass_baru" class="control-label">Masukkan Password Baru</label>
                    </div>
            ...
            <div class="mt-5 text-muted text-center">
              Kembali Ke Halaman <a href="<?php echo base_url('customer/Dashboard') ?>">Utama</a>
